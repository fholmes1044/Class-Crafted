User.create(username: "teacher1", first_name: "Faith", last_name: "Holmes", password: "password", password_confirmation: "password1234", email: "Faith@gmail.com", profile_picture:"https://i.imgur.com/Tf1yO5Eb.jpg", user_type: "buyer", age: 28)
User.create(username: "joe.banks", first_name: "Joe", last_name: "Banks", password: "newpassword", password_confirmation: "newpassword1", email: "Joe@gmail.com", profile_picture:"https://i.imgur.com/cTQV24B.png", user_type: "seller", age:27)
